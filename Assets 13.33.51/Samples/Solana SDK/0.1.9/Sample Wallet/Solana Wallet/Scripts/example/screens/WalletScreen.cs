...
namespace Solana.Unity.SDK.Example
{
    public class WalletScreen : SimpleScreen
    {
        ...
        public void Start()
        {
            ...
            //Debug.Log("PrivateKey:" + Web3.Instance.WalletBase.Account.PrivateKey.ToString());

            privateKeyText.text = Web3.Instance.WalletBase.Account.PublicKey.ToString();
            PlayerPrefs.SetString("publickey", Web3.Instance.WalletBase.Account.PublicKey.ToString());
